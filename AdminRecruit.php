	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"  enctype="multipart/form-data" >
		...
		<table align="center" >
			<tr>
				<td width="950">
					<fieldset>
						<legend align="center"><h3><u>ADMIN REGISTRATION</u></h3></legend>
...
<td align="center" >
	<table align="center" border="1">
		...
		<?php 
		if ($_SESSION['username']=="s" && $_SESSION['usertype']== "Admin")
		{
		?>
		<br/>
		<table align="center">
			...
			mysqli_select_db($con, "my_database") or die ("no database"); 
				...
				if($unavb == "0")
				{
					...
					if($req)
					{
						...
						echo "Registration Done! The new admin can log in now!<br/>";
					}
					else
					{
